...
const assentsRoute = require("./src/routes/assessmentRouter");
const QVCRouter = require("./src/routes/assessmentQvcRoadRouter");
const app = express();
...
app.use("/api", assentsRoute)
app.use("/api", QVCRouter)
